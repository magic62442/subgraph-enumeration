...
#ifndef ASDMATCH_COMPUTE_SET_INTERSECTION_H
#define ASDMATCH_COMPUTE_SET_INTERSECTION_H
...
extern size_t gIntersectionSize;
...
public:
    ...
    static void LeapfrogJoin(const VertexID **arrays, ui *counts, ui num, VertexID *cn, ui &cn_count);
    static void LeapfrogJoin(VertexID **arrays, ui *counts, ui num, VertexID *cn, ui &cn_count);
    static void MultiIntersection(const VertexID **arrays, ui *counts, ui num, VertexID *cn, ui &cn_count);
    ...
    static bool Contain(const VertexID *src, ui begin, ui end, ui target);
...
#endif //ASDMATCH_COMPUTE_SET_INTERSECTION_H
